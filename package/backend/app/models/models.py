from sqlalchemy import Column, Integer, String, DateTime, Text, Boolean, ForeignKey, Float, LargeBinary
...
class OptimizationSession(Base):
    ...
    source_file_blob = Column(LargeBinary, nullable=True)
    source_text_hash = Column(String(64), nullable=True)
    word_count = Column(Integer, default=0)
    char_count = Column(Integer, default=0)
    chinese_char_count = Column(Integer, default=0)
    english_word_count = Column(Integer, default=0)
    document_meta = Column(Text, nullable=True)
    preserve_format_available = Column(Boolean, default=False)
...
class OptimizationSegment(Base):
    ...
    source_block_id = Column(String(100), nullable=True)
    source_block_type = Column(String(50), nullable=True)
    source_block_index = Column(Integer, nullable=True)
    source_text_offset_start = Column(Integer, nullable=True)
    source_text_offset_end = Column(Integer, nullable=True)
    replacement_strategy = Column(String(50), nullable=True)
    structure_meta = Column(Text, nullable=True)
    created_at = Column(DateTime, default=datetime.utcnow)
    completed_at = Column(DateTime, nullable=True)
